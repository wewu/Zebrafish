...
require 'biodatabases_controller'

# Re-raise errors caught by the controller.
class BiodatabasesController; def rescue_action(e) raise e end; end

class BiodatabasesControllerTest < Test::Unit::TestCase
  fixtures :biodatabases

  def setup
    @controller = BiodatabasesController.new
